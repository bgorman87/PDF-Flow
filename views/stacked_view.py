...
from views import console_view, template_view, settings_view, data_viewer_view, process_view
from view_models import main_view_model, stacked_view_model, console_view_model, settings_view_model, template_view_model, data_viewer_view_model, process_view_model
...
class StackedWidget(QtWidgets.QStackedWidget):
    def __init__(self, main_view_model: main_view_model.MainViewModel):
        ...
        self.process_view = process_view.ProcessView(process_view_model.ProcessViewModel(self.main_view_model))
