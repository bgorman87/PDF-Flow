...
class ApplyFoundData(QDialog):
    ...
    def __init__(self, coords, found_text, dialog_type={"parameter": False, "profile": False, "project_number": False}, parent=None):
        ...
        elif dialog_type.get("profile") is not None:
